package com.secret.bussiness.dewu.domain.baseinfo;
...
public class BaseInfoData {
    ...
    private BaseInfoLegalInfo legalInfo;
    ...
    public void setLegalInfo(BaseInfoLegalInfo baseInfoLegalInfo) {
        this.legalInfo = baseInfoLegalInfo;
    }
    public BaseInfoLegalInfo getLegalInfo() {
        return legalInfo;
    }
