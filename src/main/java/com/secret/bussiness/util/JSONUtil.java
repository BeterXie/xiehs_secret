...
public class JSONUtil {
     ...
     * @return
     */
    public static <T> List<T> toList(JSONArray jsonArray, Object object) {
     ...
     * @return
     */
    public static <T, D> T toBean(String jsonString, Class<T> mainClass, String detailName, Object detailObject) {
        JSONObject jsonObject = JSONObject.fromObject(jsonString);
        JSONArray jsonArray = (JSONArray) jsonObject.get(detailName);

        T mainEntity = JSONUtil.toBean(jsonObject, mainClass);
        List<D> detailList = JSONUtil.toList(jsonArray, detailObject);
    ...
    public static <T, D1, D2> T toBean(String jsonString, Class<T> mainClass, String detailName1,
                                       Object detailClass1, String detailName2, Object detailClass2) {
        JSONObject jsonObject = JSONObject.fromObject(jsonString);
    ...
    public static <T, D1, D2, D3> T toBean(String jsonString, Class<T> mainClass, String detailName1,
                                           Object detailClass1, String detailName2, Object detailClass2, String detailName3,
                                           Object detailClass3) {
        JSONObject jsonObject = JSONObject.fromObject(jsonString);
        JSONArray jsonArray1 = (JSONArray) jsonObject.get(detailName1);
        JSONArray jsonArray2 = (JSONArray) jsonObject.get(detailName2);
